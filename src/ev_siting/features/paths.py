...
# --- cờ toạ độ bẩn (F4) ---
# Loại khỏi anchor T0 + baseline covered0 (toạ độ giả -> coverage ảo; COORD_PLACEHOLDER
...
DIRTY_COORD_FLAGS = frozenset({"COORD_INVALID", "COORD_ADDR_MISMATCH", "COORD_PLACEHOLDER", "DUP_COORD_SUSPECT"})
