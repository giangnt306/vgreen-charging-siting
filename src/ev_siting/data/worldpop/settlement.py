...
* Cờ `pop_unsupported` — bằng chứng đất đai **mâu thuẫn** với dân số được gán. Chính sách
  giống E-DQ1: **gắn cờ, không sửa**. Không có nguồn dân số thẩm quyền trong repo để sửa,
  và việc phân bổ lại dân cư là can thiệp mô hình, không phải làm sạch dữ liệu.

Chạy (sau `build_demand_h3` và `landuse.worldcover`)::
...
from .paths import DEMAND_DIR, DEMAND_H3, ensure_dirs
