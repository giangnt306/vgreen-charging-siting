...
> Nguồn `pop` cho `demand_h3` ([SCHEMA_CONTRACT.md](SCHEMA_CONTRACT.md) mục 3;
> [problem-analysis.md](problem-analysis.md) mục 2 #6). Đây là mảnh cuối ghép với tầng
> **OSM POI + road** ([crawler-osm.md](crawler-osm.md)) để có `demand_h3` đầy đủ.
...
| `road_len_m`, `road_len_mt_m` | double | OSM roads ([crawler-osm.md](crawler-osm.md)) |
