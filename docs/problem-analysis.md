...
| ☐ | **17→21/07** | Giang       | Khảo sát nguồn dân số / POI / OSM cho demand proxy                                | **In:** khu vực mục tiêu (1 thành phố). **Out:** danh mục nguồn khả dụng (WorldPop, OSM Geofabrik, POI) + đánh giá độ phủ/chất lượng + cách tải                                                                                                           |
| ☐ | **17→22/07** | Kỳ         | Research facility location: p-median, MCLP, set cover + case study EV                  | **In:** tài liệu học thuật + case study EV siting. **Out:** bảng so sánh mô hình + **lý do chọn MCLP làm baseline** (đưa vào report define)                                                                                                               |
